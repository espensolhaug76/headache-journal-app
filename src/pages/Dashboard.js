...
// Import headache images - Updated to match your uploaded images
...
import hemicraniaImg from '../assets/headache-types/hemicrania-continua.png';
...
export default function RecordHeadache() {
  ...
  // Updated headache types with your uploaded images
  const headacheTypes = [
    {
      id: 'tension',
    ...
    },
    {
      ...
      pattern: 'High blood pressure related'
    },
    {
      id: 'ice-pick',
    ...
    },
    {
      ...
      description: 'Positional headache',
      image: spinalHeadacheImg,
      pattern: 'Worse when upright, better lying down'
    },
    {
      id: 'thunderclap',
      name: 'Thunderclap Headache',
      description: 'Sudden severe onset',
      image: thunderclapHeadacheImg,
      pattern: 'Sudden, severe "worst headache of life"'
    },
    {
      id: 'post-traumatic',
      name: 'Post-Traumatic Headache',
      description: 'After head injury',
      image: postTraumaticHeadacheImg,
      pattern: 'Following head trauma or concussion'
    },
    {
      id: 'hemicrania',
      name: 'Hemicrania Continua',
      description: 'Continuous one-sided',
      image: hemicraniaImg,
      pattern: 'Continuous pain on one side of head'
    }
  ];
  ...
  // Continue with remaining modes (auto-timer, end-headache, manual-entry)
  // These remain the same as your existing implementation...
